...
function sanitizeItem(item) {
  ...
  return {
    ...
    attachments,
    authorName: pickPreferredString(item.authorName, null),
    authorUrl: normalizeUrl(item.authorUrl),
    sharedByAuthorName: pickPreferredString(item.sharedByAuthorName, null),
    sharedByAuthorUrl: normalizeUrl(item.sharedByAuthorUrl),
...
function mergeTwoItems(existing, incoming) {
  ...
  return {
    ...
    attachments,
    authorName: pickPreferredString(incomingItem.authorName, existingItem.authorName),
    authorUrl: incomingItem.authorUrl || existingItem.authorUrl,
    sharedByAuthorName: pickPreferredString(
      incomingItem.sharedByAuthorName,
      existingItem.sharedByAuthorName
    ),
    sharedByAuthorUrl: incomingItem.sharedByAuthorUrl || existingItem.sharedByAuthorUrl,
    publishedAt,
    usedFallbackDate,
